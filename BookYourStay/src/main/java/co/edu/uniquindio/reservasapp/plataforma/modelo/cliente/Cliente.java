...
//
//    public Cliente(String cedula, String nombre, String apellido, String email, String contrasena, String numeroTelefono) {
//        super(cedula, nombre, apellido, email, contrasena);
