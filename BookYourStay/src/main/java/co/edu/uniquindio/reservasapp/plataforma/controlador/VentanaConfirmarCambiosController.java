...
public class VentanaConfirmarCambiosController implements Initializable {
    ...
    public void CrearCodigoVerificacion() {
        ...
        EnvioEmail.enviarNotificacion(
                sesionActual.getPersona().getEmail(),
                "Código de verificación",
                "Su código de verificación es: " + codigoVerificacion
        );
    }

    public String generarCodigoAleatorioSeguro() {
        SecureRandom secureRandom = new SecureRandom();
        int codigo = 100000 + secureRandom.nextInt(900000); // Generates a number between 100000 and 999999
    ...
    public void onVerificarCodigo(ActionEvent event){
        if (txtCodigo.getText().equals(codigoVerificacion)){
            ...
            controladorPrincipal.mostrarAlerta("Los códigos no coinciden", Alert.AlertType.ERROR);
        }
    }
